...
export const metadata: Metadata = {
  title: "NeXT Up — Productivity App",
  description: "Cross-device reminder and productivity application by Boyo Apps.",
};
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      ...
      <div className="mt-12 flex flex-wrap gap-4 border-t border-border pt-8">
        {product.googlePlay && (
          <CTA href={product.googlePlay} variant="secondary">View on Google Play &rarr;</CTA>
        )}
